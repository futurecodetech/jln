...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("JLN");
    case mBTC: return QString("mJLN");
    case uBTC: return QString::fromUtf8("μJLN");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("Julians"));
    case mBTC: return QString(QObject::tr("Milli-Julians (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-Julians (1 / 1,000,000)"));
    default: return QString("???");
    }
}
